            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-8 p-8">
                ...
                <motion.div
                  ...
                  className={`bg-gray-800 rounded-md p-4 shadow-lg flex flex-col items-center ${
                    product.product_id% 2 === 0 ? 'md:col-span-2 lg:col-span-1' : 'lg:col-span-2 xl:col-span-1'
                  }`}
                ...
                >
                  ...
                  <div className="text-gray-400 text-sm mb-2">Seller: {product.email}</div>
                  <h3>{product.product_category}</h3>
                  <Link to={`/checkauthenticity`} className="text-gray-400 text-sm underline mt-2">
                    Show More Info
                  </Link>
                </motion.div>
            </div>
